...
<div class="wrapper-md">
    <div class="bg-white padder-md">
        ...
        <div class="form-group">
            ...
            <small class="form-text text-muted m-b-none">{{ trans('dashboard::systems/settings.default') }}</small>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" data-role="tagsinput" class="form-control" required name="site_keywords" value="{{ $site_keywords or '' }}">
            <small class="form-text text-muted m-b-none">{{ trans('dashboard::systems/settings.default') }}</small>
        </div>
        ...
        <div class="form-group">
            ...
            <textarea class="form-control no-resize" required name="site_description" rows="4">{{$site_description or ''}}</textarea>
            <small class="form-text text-muted m-b-none">{{ trans('dashboard::systems/settings.description-help') }}</small>
        </div>
        ...
        <div class="form-group">
            ...
            <small class="form-text text-muted m-b-none">{{ trans('dashboard::systems/settings.email-help') }}</small>
        </div>
    </div>
</div>
